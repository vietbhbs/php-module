...
namespace nguyenanhung\Backend\vietbhbs_module\Base;

use nguyenanhung\MyDebug\Benchmark;
use nguyenanhung\MyDebug\Logger;
use nguyenanhung\MyCache\Cache;
use nguyenanhung\MyRequests\MyRequests;
use nguyenanhung\Backend\vietbhbs_module\Helper\Helper;

/**
 * Class BaseCore
 *
 * @package   nguyenanhung\Backend\vietbhbs_module\Base
...
class BaseCore
{
    ...
    /** @var \nguyenanhung\Backend\vietbhbs_module\Helper\Helper */
    protected $helper;
